...
/** @hidden */
export declare const byMonth: (date: any, _end: any, rule: RecurrenceRule) => boolean;
/** @hidden */
...
/** @hidden */
export declare const byHour: (date: any, _end: any, rule: RecurrenceRule) => boolean;
/** @hidden */
export declare const byMinute: (date: any, _end: any, rule: RecurrenceRule) => boolean;
/** @hidden */
