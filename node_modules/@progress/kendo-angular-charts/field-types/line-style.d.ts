 ...
 * - `"step"`&mdash;Connects the values with a right-angled line. Available when [`series.type`](https://www.telerik.com/kendo-angular-ui/components/charts/api/series#type) is set to `"line"`.
