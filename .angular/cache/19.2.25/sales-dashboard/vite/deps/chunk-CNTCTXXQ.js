...
function u(e2, t2, n2, i2) {
  ...
  if (!!document.documentElement.dispatchEvent(s2)) {
    const e3 = (e4) => {
      e4.detail.productCode !== t2 && n2({
        message: e4.detail.message,
        productCode: e4.detail.productCode
      }), e4.preventDefault();
    };
...
//# sourceMappingURL=chunk-CNTCTXXQ.js.map
