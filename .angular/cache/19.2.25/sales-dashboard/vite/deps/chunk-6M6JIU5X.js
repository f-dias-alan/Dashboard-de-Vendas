  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_0 = goog.getMsg("Progressbar");
        i18n_0 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_0;
      } else {
...
var ChunkProgressBarComponent = class _ChunkProgressBarComponent extends ProgressBarBase {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_1;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_1 = goog.getMsg("Chunk progressbar");
        i18n_1 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_1;
      } else {
...
var CircularProgressBarComponent = class _CircularProgressBarComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_2 = goog.getMsg("Circular progressbar");
        i18n_2 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_2;
      } else {
...
function TabStripComponent_ng_template_3_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(2);
    ɵɵproperty("scrollable", ctx_r1.scrollable)("tabPosition", ctx_r1.tabPosition)("prev", true)("title", ctx_r1.localization.get("previousTabButton"))("ngClass", ɵɵpureFunction3(5, _c19, ctx_r1.size === "small", ctx_r1.size === "medium", ctx_r1.size === "large"));
  }
}
function TabStripComponent_ng_template_3_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(2);
    ɵɵproperty("scrollable", ctx_r1.scrollable)("tabPosition", ctx_r1.tabPosition)("prev", false)("title", ctx_r1.localization.get("nextTabButton"))("ngClass", ɵɵpureFunction3(5, _c19, ctx_r1.size === "small", ctx_r1.size === "medium", ctx_r1.size === "large"));
  }
}
...
function DrawerListComponent_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, DrawerListComponent_For_1_Conditional_0_Template, 1, 12, "li", 0)(1, DrawerListComponent_For_1_Conditional_1_Template, 1, 2, "li", 1);
  }
  if (rf & 2) {
...
function DrawerComponent_Conditional_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtwoWayListener("viewChange", function DrawerComponent_Conditional_0_Conditional_1_Template_ul_viewChange_1_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext(2);
      ɵɵtwoWayBindingSet(ctx_r1.viewItems, $event) || (ctx_r1.viewItems = $event);
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("mini", ctx_r1.mini)("expanded", ctx_r1.expanded);
    ɵɵtwoWayProperty("view", ctx_r1.viewItems);
    ɵɵproperty("itemTemplate", ctx_r1.itemTemplate == null ? null : ctx_r1.itemTemplate.templateRef);
    ɵɵadvance();
...
function CardActionsComponent_Conditional_1_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassProp("k-button-flat", action_r2.flat)("k-button-primary", action_r2.primary);
    ɵɵadvance(2);
...
function CardActionsComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵrepeaterCreate(0, CardActionsComponent_Conditional_1_For_1_Template, 3, 5, "button", 1, ɵɵrepeaterTrackByIdentity);
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
...
function TimelineHorizontalComponent_Conditional_10_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵadvance(2);
    ɵɵproperty("event", ctx_r2.selectedCardIndex === ɵ$index_35_r8 ? ctx_r2.selectedEvent : null)("expanded", true)("collapsible", ctx_r2.collapsibleEvents)("calloutStyle", ctx_r2.selectedCardIndex === ɵ$index_35_r8 ? ctx_r2.calloutStyle : ɵɵpureFunction0(12, _c422))("ngStyle", ɵɵpureFunction1(13, _c43, ctx_r2.selectedCardIndex === ɵ$index_35_r8 ? "visible" : "hidden"))("tabIndex", ctx_r2.selectedCardIndex === ɵ$index_35_r8 ? "0" : "-1")("navigable", ctx_r2.navigable)("index", ctx_r2.selectedEventIndex)("headerTemplate", ctx_r2.headerTemplate)("bodyTemplate", ctx_r2.bodyTemplate)("actionsTemplate", ctx_r2.actionsTemplate)("eventHeight", ctx_r2.eventHeight);
  }
}
...
function TimelineVerticalComponent_Conditional_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, TimelineVerticalComponent_Conditional_0_For_2_Conditional_0_Template, 3, 1, "li", 3);
...
var mapShapeToRounded = (shape) => SHAPE_TO_ROUNDED[shape] || void 0;
...
var TabStripService = class _TabStripService {
  ...
  cdr;
  owner;
  constructor(localization, ngZone, cdr) {
    this.localization = localization;
    this.ngZone = ngZone;
    this.cdr = cdr;
  }
  ...
  static ɵfac = function TabStripService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _TabStripService)(ɵɵinject(LocalizationService), ɵɵinject(NgZone), ɵɵinject(ChangeDetectorRef));
  };
  static ɵprov = ɵɵdefineInjectable({
  ...
  */
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function TabStripComponent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵattribute("dir", ctx.dir);
        ɵɵclassProp("k-tabstrip", ctx.hostClasses)("k-tabstrip-top", ctx.tabsAtTop)("k-tabstrip-right", ctx.tabsAtRight)("k-tabstrip-bottom", ctx.tabsAtBottom)("k-tabstrip-left", ctx.tabsAtLeft)("k-tabstrip-scrollable", ctx.tabStripScrollable)("k-tabstrip-scrollable-overlay", ctx.tabStripScrollableOverlay);
      }
    },
    inputs: {
      height: "height",
    ...
    consts: () => {
      let i18n_0;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_0 = goog.getMsg("Close");
        i18n_0 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_0;
      } else {
        i18n_0 = $localize`:kendo.tabstrip.closeTitle|The title for the **Close** button in the TabStrip tab.:Close`;
      }
      let i18n_1;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_1 = goog.getMsg("Previous Tab");
        i18n_1 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_1;
      } else {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function DrawerComponent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵstyleProp("margin-left", ctx.overlayMarginLeft)("margin-right", ctx.overlayMarginRight)("flex-basis", ctx.flexStyles, "px");
    ...
    decls: 2,
    vars: 2,
    consts: [[1, "k-drawer-wrapper", 3, "width"], ["kendoWatermarkOverlay", "", 3, "licenseMessage"], [1, "k-drawer-wrapper"], [3, "ngTemplateOutlet"], ["kendoDrawerList", "", "role", "menubar", "aria-orientation", "vertical", 1, "k-drawer-items", 3, "select", "viewChange", "mini", "expanded", "view", "itemTemplate"]],
  ...
  */
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_3;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_3 = goog.getMsg("Optional");
        i18n_3 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_3;
      } else {
...
var AvatarComponent = class _AvatarComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_4;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_4 = goog.getMsg("Avatar");
        i18n_4 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_4;
      } else {
...
var CardActionsComponent = class _CardActionsComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 3,
    vars: 3,
    consts: [[3, "ngTemplateOutlet"], ["type", "button", 1, "k-button", 3, "k-button-flat", "k-button-primary"], ["type", "button", 1, "k-button", 3, "click"], [1, "k-button-text"]],
...
var TimelineComponent = class _TimelineComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_5;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_5 = goog.getMsg("previous");
        i18n_5 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_5;
      } else {
        i18n_5 = $localize`:kendo.timeline.previous|The title of the previous button in horizontal orientation.:previous`;
      }
      let i18n_6;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_6 = goog.getMsg("next");
        i18n_6 = MSG__HOME_FADOD_DOWNLOADS_DASHBOARD_ANGULAR_KENDOUI_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_6;
      } else {
...
//# sourceMappingURL=chunk-6M6JIU5X.js.map
